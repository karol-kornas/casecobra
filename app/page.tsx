          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                CaseCobra allows you to protect your memories, not just phone
                case.
              </p>
              <ul className="mt-8 space-y-2 text-left font-medium flex flec-col items-center sm-items-start">
          ...
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                ...
                <span className="px-2 relative bg-green-600 text-white">
                  your own case
                </span>{" "}
                now
              </h2>
